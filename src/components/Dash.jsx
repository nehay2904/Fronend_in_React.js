...
import Dash_logo from '.././Images/Bloodten.jpg'
  ...
  return (
    <div className='home'>
        ...
        <div className="navbar">
         ...
         <Link style={{marginTop:7}}  to='register'><button className='start_btn'>View Profile</button></Link>
       ...
       <div className="body">
        ...
        <div className="right_body">
          <img className='Dash_logo' src={Dash_logo} alt="" srcset="" />
        </div>
       </div>
    </div>
  )
